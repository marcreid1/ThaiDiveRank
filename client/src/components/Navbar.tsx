      ...
      {mobileMenuOpen && (
        <div className="sm:hidden" id="mobile-menu">
          <div className="pt-2 pb-3 space-y-1 bg-background border-t border-border">
            ...
            {/* Mobile authentication controls - always visible at top */}
              ...
              {isAuthenticated ? (
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="flex items-center w-full text-left px-4 py-3 mx-3 text-base font-semibold text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/20 rounded-lg border-2 border-red-200 dark:border-red-700 transition-colors"
                  >
                ...
                <Link 
                  href="/auth"
                  className="flex items-center px-4 py-3 mx-3 text-base font-semibold text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:text-blue-300 dark:hover:bg-blue-900/20 rounded-lg border-2 border-blue-200 dark:border-blue-700 transition-colors"
                  onClick={() => setMobileMenuOpen(false)}
                >
