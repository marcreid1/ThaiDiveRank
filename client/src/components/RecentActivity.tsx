                ...
                <div className="flex space-x-3">
                  <div className="flex-shrink-0">
                    <div className="h-10 w-10 rounded-full bg-ocean-100 dark:bg-ocean-900/30 flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-ocean-600 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm text-slate-800 dark:text-slate-200">
                      <a href="#" className="font-medium text-ocean-600 dark:text-white hover:underline">{activity.winnerName}</a>
                      {" "}won against{" "}
                      <a href="#" className="font-medium text-ocean-600 dark:text-white hover:underline">{activity.loserName}</a>
                    </p>
